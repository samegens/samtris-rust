...
pub const NEXT_TETROMINO_OFFSET_X: u32 = PLAYFIELD_OFFSET_X + (PLAYFIELD_WIDTH * BLOCK_SIZE) + (2 * BLOCK_SIZE);
pub const NEXT_TETROMINO_OFFSET_Y: u32 = PLAYFIELD_OFFSET_Y + (2 * BLOCK_SIZE);
pub const NEXT_TETROMINO_AREA_WIDTH: u32 = 4; // In blocks
pub const NEXT_TETROMINO_AREA_HEIGHT: u32 = 4; // In blocks